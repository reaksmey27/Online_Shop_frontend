...
// ── Google Login ─────────────────────────────────────────
// Google's OAuth flow does a full-page redirect (see authStore.loginWithGoogle),
// so there's no 'success' emit here — the browser navigates away and comes back
// authenticated via the callback route.
